 ...
 * @author rayan
 */
public class StastiquePieForm extends BaseForm {
    ...
    Form current;
BaseForm form;
        public StastiquePieForm(Resources res)  {
        ...
        RadioButton popular = RadioButton.createToggle("Categorie User", barGroup);
